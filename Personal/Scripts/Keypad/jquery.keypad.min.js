! function(a) {
    ...
    a.JQPlugin.createPlugin({
        ...
        _init: function() {
            this.mainDiv = a('<div class="' + this._mainDivClass + '" style="display: none;"></div>'), this._super()
        },
        ...
        show: function(b) {
            if (b = b.target || b, !c.isDisabled(b) && c._lastField !== b) {
                ...
                a(b).parents().each(function() {
                    return !(e = e || "fixed" === a(this).css("position"))
                });
                var f = {
                    left: c._pos[0],
                    top: c._pos[1]
        ...
        hide: function(b, c) {
            ...
            if (d && (!b || d === a.data(b, this.name))) {
                if (this._keypadShowing) {
                    d._mainDiv.stop(!0, !0), c = void 0 !== c && null !== c ? c : d.options.duration;
        ...
        _clearValue: function(a) {
            this._setValue(a, "", 0), this._notifyKeypress(a, c.DEL), a._input.focus()
        },
        _backValue: function(a) {
            var b = a._input[0],
                d = a._input.val(),
                e = [d.length, d.length];
            e = a._input.prop("readonly") || a._input.prop("disabled") ? e : b.setSelectionRange ? [b.selectionStart, b.selectionEnd] : b.createTextRange ? this._getIERange(b) : e, this._setValue(a, 0 === d.length ? "" : d.substr(0, e[0] - 1) + d.substr(e[1]), e[0] - 1), this._notifyKeypress(a, c.BS), a._input.focus()
        },
